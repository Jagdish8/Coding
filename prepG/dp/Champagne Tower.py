...
#  For example, if poured = 10 cups are poured at the top,
#   then the total flow-through of the top glass is 10;
...
#  quantity of champagne will equally flow left and right.
